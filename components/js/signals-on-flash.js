    ...
    var disclaimer_text = 
        ...
        \
        This dashboard reports flashing traffic signals in Austin, Texas. Approximately 90% of the City’s signals communicate with our Advanced Trasnportation Management System.  When these signals go on flash, they will be reported on this dashboard.  Although we are extending communications to all signals, approximately 10% are not currently reported on this dashboard.  It also occasionally happens that the event that disables a traffic signal will also disable network communication to the signal, in which case the signal outage will not be reported here.<br><br> \
